...
const UpdateMembershipButton: React.FC<Props> = ({
  hasPaymentMethods,
  onSuccess,
  currentSubscription,
  popupAuto,
  ...
  return (
    <>
      <Button onClick={toggleModal} outlined size="small">
        {t('settingsPage.payments.updateMembershipButton.buttonText')}
      </Button>
...
export default UpdateMembershipButton;
