...
export const TalentsCardContainer = styled.div`
  display: flex;
  overflow-x: scroll;
  margin-top: 2%;
`;
...
export const ButtonsContaine = styled.div`
  justify-content: flex-end;
  display: flex;
  align-items: center;
  margin-top: -20px;
...
export const RedeemButton = styled.div<{
  ...
  & a {
    ...
    background-color: ${(props) => (props.disabled ? '#c9c9c9' : '#f50756')};
    padding: 0 20px;
    height: 40px;
    color: #fff;
    font-family: 'Sofia Pro';
...
export const RecommendedEventsTitle = styled.h2`
  font-family: 'Sofia Pro';
  font-weight: 700;
  font-size: 30px;
  color: ${colors.black};
